...
const fetchMovies = ()=>{
    fetch("http://localhost:5000/movies").then((response)=>response.json()).then((res)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gzp3I","1Z4Rq"], "1Z4Rq", "parcelRequire1228")
